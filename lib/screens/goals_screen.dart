...
class _GoalsScreenState extends State<GoalsScreen>
  ...
  final ValueNotifier<Map<int, dynamic>> forecastsNotifier = ValueNotifier({});

  final ValueNotifier<Map<int, dynamic>> insightsNotifier = ValueNotifier({});
  ...
  Future<void> refreshSingleGoal(int goalId) async {
    ...
    try {
      ...
      if (mounted) {
        final updated = Map<int, dynamic>.from(forecastsNotifier.value);

        updated[goalId] = forecast;

        forecastsNotifier.value = updated;
      }
    } catch (_) {}
    ...
    try {
      ...
      if (mounted) {
        final updated = Map<int, dynamic>.from(insightsNotifier.value);

        updated[goalId] = insight;
  ...
  Future<void> loadGoalInsights() async {
    ...
    insightsNotifier.value = insightsMap;
  }
                  ...
                  ...goals.map<Widget>((goal) {
                    ...
                    return Dismissible(
                      ...
                      onDismissed: (direction) async {
                        ...
                        // Temporarily remove from UI list
                        setState(() {
                        ...
                        ScaffoldMessenger.of(context)
                            .showSnackBar(
                              SnackBar(
                                ...
                                action: SnackBarAction(
                                  label: "Undo",
                                  onPressed: () async {
                                    // Put goal back into UI list
                                    setState(() {
                                      goals.insert(0, goal);
                                    });

                                    // Restore goal depending on connectivity
                                    if (connectivity.isOnline &&
                                        goal['server_id'] != null) {
                            ...
                            .closed
                            .then((reason) async {
                              // Only commit delete if SnackBar expired without Undo
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              ValueListenableBuilder<Map<int, dynamic>>(
                                valueListenable: insightsNotifier,
                              ...
                              ValueListenableBuilder<Map<int, dynamic>>(
                                valueListenable: forecastsNotifier,
                                builder: (_, forecasts, __) {
                                  final forecast =
                                      forecasts[goal['id']]
                                          as Map<String, dynamic>?;
                                      ...
                                      if (forecast != null)
                                        FadeSlideAnimation(
                                          ...
                                          child: Container(
                                            ...
                                            padding: const EdgeInsets.all(18),
                                            decoration: BoxDecoration(
                                              color: forecastColor.withOpacity(
                                                .08,
                                              ),
                                              borderRadius:
