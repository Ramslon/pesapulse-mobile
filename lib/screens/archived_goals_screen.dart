  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: archivedGoals.isEmpty
          ? buildEmptyState(context, EmptyStateType.archivedGoals)
          : Column(
                  ...
                  child: RefreshIndicator(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final saved =
                            double.tryParse(goal['saved_amount'].toString()) ??
                            0;
                                  ...
                                  child: ElevatedButton.icon(
                                    ...
                                    onPressed: () async {
                                      ...
                                      setState(() {
                                        ...
                                        _archivedCache = List.from(
                                          archivedGoals,
                                        );
                                      });
                                      SyncEvents.instance.notifyGoalsUpdated();
                                      SyncEvents.instance
                                          .notifyArchivedUpdated();
